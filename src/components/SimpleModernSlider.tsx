...
interface SimpleModernSliderProps {
	value: number;
	onChange: (value: number) => void;
	label?: string;
}

const SimpleModernSlider: React.FC<SimpleModernSliderProps> = ({ value, onChange, label = "Volume" }) => {
	return (
		<div className="px-10">
			...
			<div className="relative">
				<p
					className="absolute top-0 text-xs font-medium rounded-full text-neutral-500"
					style={{
...
export default SimpleModernSlider;
